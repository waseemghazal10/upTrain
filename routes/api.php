...
Route::get('/getProgramCompany/{companyName}', [CompanyController::class, 'getProgramCompany']);
Route::get('/getProgramTrainer/{trainerEmail}', [TrainerController::class, 'getProgramTrainer']);//check if wepu;; can get the id
